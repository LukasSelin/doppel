...
| `-o`, `--output`    | *(disabled)* | Write report as Markdown to this file. The Markdown report opens with what doppel understands about the corpus — concept vocabulary, duplication map, package habitats — as mermaid diagrams, then how this codebase *writes* things: what a concept looks like here, what travels with what, and which functions drift from their own concept. The stdout report is still printed |
